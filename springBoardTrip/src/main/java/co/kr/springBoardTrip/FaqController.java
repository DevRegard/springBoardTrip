...
public class FaqController {
	...
	public String faq_writePro(@ModelAttribute("faqDto") FaqDto faqDto, HttpServletRequest request)
		...
		sqlSession.insert("faq.insertFaq", faqDto); //insert, DB처리
		
		return "redirect:faq_list.do"; 
		//JSP의 response.sendRedirect("list.jsp")같다
	...
	throws IOException, NamingException{
		...
		return ".main.faq.faq_content"; //뷰 리턴, views/faq/faq_content.jsp
	}
	...
	throws IOException, NamingException{
		...
		mv.setViewName(".main.faq.faq_updateForm"); //뷰 저장
	...
	public String faq_updatePro(String num, String pw, Model model, FaqDto faqDto, String pageNum)
		...
		if(faqDto1 == null) {
			...
			return ".main.faq.faq_updateForm";
		}else{
	...
	throws IOException, NamingException{
		...
		mv.setViewName(".main.faq.faq_delete");
