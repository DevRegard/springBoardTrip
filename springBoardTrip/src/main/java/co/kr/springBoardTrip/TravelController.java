...
public class TravelController {
	...
	public String writePro(@ModelAttribute("travelDto") TravelDto travelDto, HttpServletRequest request)
		...
		sqlSession.insert("travel.insertTravel", travelDto); //insert, DB처리
	...
	public String listtravel(Model model, String pageNum)
		...
		return ".main.travel.travel_list";
	}
	...
	throws IOException, NamingException{
		...
		sqlSession.update("travel.readCount", num1); //조회수 증가
	...
	throws IOException, NamingException{
		...
		mv.setViewName(".main.travel.travel_updateForm"); //뷰 저장 (ModelAndView)
	...
	public String travel_updatePro(String num, String pw, Model model, TravelDto travelDto, String pageNum)
		...
		if(travelDto1 == null) {
			...
			return ".main.travel.travel_updateForm";
		}else{
	...
	throws IOException, NamingException{
		...
		mv.setViewName(".main.travel.travel_delete");
	...
	public String deletePro(String num, String pw, Model model, TravelDto travelDto, String pageNum)
		...
		if (travelDto1 == null) {
			...
			return ".main.travel.travel_delete";
		} else {
